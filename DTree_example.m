...
cv = cvpartition(y, 'holdout', 30);
% [1,589,733, 1429, 2500, 3500, 5000, 6200 7000, 7502]  % 0 9 A C H N S e o u
...
mdl_ctree = ClassificationTree.fit(Xtrain,Ytrain);   % mdl_ctree = ClassificationTree.fit(Xtrain,Ytrain);
