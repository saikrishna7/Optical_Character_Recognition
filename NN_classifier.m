function classifier = NN_classifier()
...
imds = imageDatastore(fullfile('74k_EnglishFntProcessedFolders64'),...
    'LabelSource','foldernames','IncludeSubfolders',true,'FileExtensions','.png');
...
% s=double('TomorrowandtomorrowandtomorrowcreepsinthispettypacefromdaytodayuntilthelastsyllableofrecordedtimeAndallouryesterdayshavelightedfoolsthewaytodusty')
